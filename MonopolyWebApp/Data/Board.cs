namespace MonopolyWebApp.Models
{
    public class Board
    {
        ...
        public Board() 
        {
            ...
            //Налог -200
            var property3 = new Property("Кинг Кросс Станция", 200, 25, 25, 50, 100, 200, 0, 100, false, 1, "White", "OWNER"); //needs special logic
            ...
            var property8 = new Property("Электрическая компания", 150, 0, 0, 0, 0, 0, 0, 0, false, 0, "White2", "OWNER");  //needs sp logic
            ...
            var property11 = new Property("Марилебоне Станция", 200,25, 25, 50, 100, 200, 0, 100, false, 0, "White", "OWNER"); //needs sp logic
            ...
            var property18 = new Property("Фенчорч Станция", 200, 25, 25, 50, 100, 200, 0, 100, false, 0, "White", "OWNER");
            ...
            var property21 = new Property("Водная Станция", 150, 0, 0, 0, 0, 0, 0, 75, false, 0, "White2", "OWNER");  //needs sp logic
            ...
            var property26 = new Property("Ливерпуль Станция", 200,25, 25, 50, 100, 200, 0,100, false,0,"White", "OWNER");
            //Chance
